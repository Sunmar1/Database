...
public class Serv {
    public static void sortByName(Connection connection) throws SQLException {
        ...
        preparedStatement = connection.prepareStatement("SELECT (b -> 'name') as b FROM jtest ORDER by b ASC;");
    ...
    public static void search(Connection connection )throws SQLException {
        ...
        PreparedStatement preparedStatement = connection.prepareStatement("SELECT a -> 'name' as json FROM jtest");
        Doctor[] doctors=new Doctor[2];
            ...
            preparedStatement=connection.prepareStatement("SELECT b -> 'name' as jsonb FROM jtest");
