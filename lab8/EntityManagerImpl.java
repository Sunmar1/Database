...
public class EntityManagerImpl  implements  EntityManager {
    ...
    Field[] getFields(Object object) {
        ...
        if (object.getClass().getCanonicalName().equals("domain.Patient")) {
            Field[] personFields = Patient.class.getSuperclass().getDeclaredFields();
            Field[] patientFields = Patient.class.getDeclaredFields();
            Field[] fields = new Field[patientFields.length + personFields.length];
            Arrays.setAll(fields, i ->
                    (i < personFields.length ? personFields[i] : patientFields[i - personFields.length]));
            return fields;
    ...
    @Override
    public void persist(Object object) throws InvocationTargetException {
...
//          System.out.println("columnName " + columnName);
                    ...
                    //если есть ссылка на др таблицу
                        ...
                        Class<?> clazz2 = Class.forName("domain." + fieldNameForMethod);
